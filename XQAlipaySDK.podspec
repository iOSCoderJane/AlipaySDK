#
# Be sure to run `pod lib lint XQAlipaySDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'XQAlipaySDK'
  s.version          = '0.1.0'
  s.summary          = 'A short description of XQAlipaySDK.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zhaoshenghui/XQAlipaySDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zhaoshenghui' => 'zhaoshenghui11@google.com' }
  s.source           = { :git => 'https://github.com/zhaoshenghui/XQAlipaySDK.git', :tag => s.version.to_s }
